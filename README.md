...
| 指令 | 角色 | 风格 |
|------|------|------|
| `/skill sts-ironclad` | 🗡️ 战士 Ironclad | 正面突破，力量碾压 |
| `/skill sts-silent` | 🏹 猎手 Silent | 精密策划，一击毙命 |
| `/skill sts-defect` | 🤖 机器人 Defect | 理性计算，最优解 |
| `/skill sts-watcher` | 👁️ 观者 Watcher | 洞悉全局，择机而定 |
...
├── README.md
│
├── sts-ironclad.skill.md        # 🗡️ 战士 skill 定义
├── sts-silent.skill.md          # 🏹 猎手 skill 定义
├── sts-defect.skill.md          # 🤖 机器人 skill 定义
├── sts-watcher.skill.md         # 👁️ 观者 skill 定义
│
└── references/
    ├── ironclad/
    │   ├── profile.md           # 角色背景设定
    │   └── style-guide.md       # "战斗风格→做事风格"映射
    ├── silent/
    ├── defect/
    └── watcher/
```
